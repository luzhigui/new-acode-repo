// V6.4.1 | ~5400 bytes | 2026-09-24 灭绝师太：召唤改阵亡触发（ON_UNIT_DEATH.MIEJUE_RECORD / BEFORE_STATE_TRANSITION.MIEJUE_SUMMON），删 MIEJUE_THIRD_MARK
import { GlobalStore } from './54-global-store.js';
export const VER = 'infra/50-event-bus.js V6.4.1';
...
export const EXECUTION_LAYER = {
    ...
    BEFORE_DAMAGE_CALC: { WARRIOR_BREAK: 10, MIEJUE_THIRD_MULT: 15, PANG_YOUNG_MULT: 16, PANG_TAUNT_REDUCE: 20, TRUE_DMG: 30 },

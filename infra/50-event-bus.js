// V6.2.0 | ~5300 bytes | 2026-09-22 相位表增补灭绝师太（MIEJUE_*）与谢逊（XIE_*）具名优先级，含 ON_BEFORE_DEATH.XIE_SACRIFICE（替死）
import { GlobalStore } from './54-global-store.js';
export const VER = 'infra/50-event-bus.js V6.2.0';
...
export const EXECUTION_LAYER = {
    ROUND_START:      { RANGE_CHECK: 5, SPIDER_TRANSFORM: 10, XUANMING_POISON: 10, XINGFEN_GRANT: 10, KULIAN_BUFF: 10, PANG_TAUNT_RESET: 12, MIEJUE_SUMMON: 14, XIE_SUMMON: 16 },
    ROUND_END:        { BUTTERFLY_RETURN: 10, SPIDER_RETURN: 10 },
    BEFORE_ACTION:    { BUTTERFLY_SKIP: 10, SPIDER_SKIP: 10, KULIAN_PRIORITY: 10 },
    BEFORE_ATTACK:     {},
    BEFORE_SELECT_TARGET: { MIEJUE_THIRD_MARK: 12, PANG_CLUMSY: 15, PANG_TAUNT_FORCE: 18, PHANTOM_CLEAR: 25, DISGUISE: 30, REBEL: 20, FLY_TARGET: 30, PERMANENT_MIND_CONTROL: 40 },
    BEFORE_DAMAGE_CALC: { WARRIOR_BREAK: 10, MIEJUE_THIRD_MULT: 15, PANG_TAUNT_REDUCE: 20, TRUE_DMG: 30 },

...
export const VER = 'ui/main.js V4.0.0';

import '../modules/error-capture.js';
import { CONFIG, STATE, KILL_TAUNT, ENEMY_M, VER as CFG_VER } from '../core/config.js';
import { Unit, rand, runBattle, getRandomTaunt, getKillTaunt, getZhangNearTaunt, makeFXSnapshot, VER as BE_VER } from '../core/engine.js';
import { stripTags, renderGrid, updateUI, spawnVictoryEffects, clearLogExceptFirst, isUnitBenefitedByBuff, VER as UI_VER } from './render.js';
import { showDanmaku, showDamageFloat, showDodgeBubble, showHealFloat, VER as FX_VER } from '../fx/fx-common.js';
import { showRangedArrow, VER as FA_VER } from '../fx/fx-arrows.js';
import { showMeleeCrash, showMeleeDodge, showMeleeMiss, VER as FC_VER } from '../fx/fx-crash.js';
import { playBattle, playLineText, clearAllEffects, handleBuffSummon, handleBuffDestroy, handleBuffLeech, handleBuffSplash, VER as BP_VER } from '../player/player-core.js';
...
export async function loadModules(updateCoverVersion) {
    const loaded = {};
    const failed = {};
    const modules = {

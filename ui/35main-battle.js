// ui/35main-battle.js - 光明顶5v5 战斗初始化
// V5.5.0 | 2026-08-14 业务逻辑下沉至 modules/35battle-init.js + modules/18global-store.js
export const VER = 'ui/35main-battle.js V5.5.0';

import { CONFIG } from '../core/01config-5v5-test.js';
import { SeededRNG } from '../core/07-rng.js';
import { addPermanentBuff } from '../modules/15elite-skills.js';
import { updateUI } from './32ui-render-5v5-test.js';
import { showModal } from './30main-utils.js';
...
// ==================== 阵容生成 ====================
// 战斗-初始化：生成明教+六大派阵容（薄壳，逻辑在 modules/35battle-init.js）

// ui/68reset-runtime.js - 光明顶5v5 战斗重置清理统一入口
// V5.4.0 | ~2200 bytes| 2026-08-14 统一 resetBattleRuntime，收口各重置路径
export const VER = 'ui/68reset-runtime.js V5.4.0';

import { GlobalStore } from '../modules/18global-store.js';
import { setRenderStore } from './32ui-render-5v5-test.js';

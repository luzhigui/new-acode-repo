...
// V5.5.0 | ~4500 bytes| 2026-08-14 getPlayerContext 下沉至 modules/18global-store.js，消除 player→ui 循环依赖
export const VER = 'ui/33main-state.js V5.5.0';

import { STATE } from '../core/01config-5v5-test.js';
import { GlobalStore } from '../modules/18global-store.js';

import { updateUI, spawnVictoryEffects, setRenderStore } from './32ui-render-5v5-test.js';
...
// ==================== 玩家上下文 — 实现已移至 modules/18global-store.js ====================
export { getPlayerContext } from '../modules/18global-store.js';

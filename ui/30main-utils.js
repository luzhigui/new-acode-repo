﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿// ui/30main-utils.js - 光明顶5v5 主控工具函数
// V5.4.0 | ~7400 bytes| 2026-07-05
export const VER = 'ui/30main-utils.js V5.4.0';
...
export function updateCoverVersion() {
    ...
    if (!el) return;
    el.innerHTML = [
        '✅ core/11battle-round.js V5.3.1',
        '✅ core/10battle-attack.js V5.3.1',
        '✅ core/04buff-system.js V5.3.1',
        '✅ player/26player-core.js V5.3.1',
        '✅ ui/32ui-render-5v5-test.js V5.3.1',
        '✅ fx/39fx-common-5v5-test.js V5.3.1',
        '✅ modules/15elite-skills.js V5.3.1',
        '✅ modules/18global-store.js V5.3.1'
    ].join('<br>');
}
...
export async function startApp(updateCoverVersion) {
    ...
    const modules = {
        ...
        '32ui-render-5v5-test.js': './32ui-render-5v5-test.js',
        '39fx-common-5v5-test.js': './39fx-common-5v5-test.js',
        '40fx-arrows-5v5-test.js': './40fx-arrows-5v5-test.js',
        '41fx-crash-5v5-test.js': './41fx-crash-5v5-test.js',
        '27battle-player-5v5-test.js': './27battle-player-5v5-test.js'
    };

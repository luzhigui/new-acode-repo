...
// 版本: V3.1.0, 预估字节: 7200, 发送时间: 20260622 20:30
export const VER = '01config-5v5-test.js V3.1.0';
...
const CONFIG = {
    ...
    BUFFS: {
        ...
        cloudBody: { name: '流云身法', desc: '己方全体闪避概率+30%', dodgeBonus: 0.25, icon: '💨' },
    ...
    ENEMY_SQUADS: {
        ...
        5: [{ name: '玄冥二老', role: '远程', m: 112 }, 104, 104, 100, 100],

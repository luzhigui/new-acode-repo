...
const MODULES = [
    ...
    'fx/41fx-crash-5v5-test.js',
    'fx/42fx-position-swap.js',
    'fx/43fx-push-back.js',
    ...
    'modules/17audio-manager.js',
    'modules/18global-store.js',
    'tools/47auto-battle-utils.js',
    'ui/33main-state.js',
    'ui/34main-dialogs.js',
    'modules/35battle-init.js',
    'ui/35main-battle.js',
...
const VER_GLOBAL_MAP = {
    ...
    '39fx-common-5v5-test.js':        'VER_FX_COMMON',
    '40fx-arrows-5v5-test.js':        'VER_FX_ARROWS',
    '41fx-crash-5v5-test.js':         'VER_FX_CRASH',
    '42fx-position-swap.js':          'VER_FX_SWAP',
    '43fx-push-back.js':              'VER_FX_PUSH',
    '44fx-dodge-bullet.js':           'VER_FX_DODGE',
    '45fx-butterfly-spider.js':       'VER_FX_BUTTERFLY',
    '15elite-skills.js':              'VER_ELITE_SKILLS',
    '16error-capture.js':             'VER_ERROR_CAPTURE',
    '17audio-manager.js':             'VER_AUDIO',
    '18global-store.js':              'VER_GLOBAL_STORE',
    '47auto-battle-utils.js':         'VER_AUTO_BATTLE_UTILS',
    '35battle-init.js':               'VER_BATTLE_INIT',
    '33main-state.js':                'VER_MAIN_STATE',
    '34main-dialogs.js':              'VER_MAIN_DIALOGS',
    '35main-battle.js':               'VER_MAIN_BATTLE',
    '36audio-control.js':             'VER_AUDIO_CTRL',
    '37fx-trigger.js':                'VER_FX_TRIGGER',
    '38ui-controls.js':               'VER_UI_CTRL',
    '31main-5v5-test.js':             'VER_MAIN'
};

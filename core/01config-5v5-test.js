...
const CONFIG = {
    ...
    FANG_LEVELS: [0.244, 0.264, 0.279, 0.292, 0.306, 0.322, 0.342, 0.373, 0.445, 0.520, 0.600, 0.660, 0.700, 0.760],
    FANG_K: [0.1, 0.12, 0.14, 0.16, 0.20, 0.24, 0.28, 0.33, 0.40, 0.50, 0.66, 0.85, 1.06, 1.28, 8.88],
    MAX_ROUND: 35,
    HP_DMG_RATIO: 0.06,
    BASE_DODGE_FLY: 0.15,

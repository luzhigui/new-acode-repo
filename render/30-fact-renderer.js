...
const FACT_RENDERERS = buildRendererMap({
    ...
    renderPassFact,
    renderKuLianPriorityFact,
    renderKuLianFact,
    renderDoubleStrikeFact,
    renderRangedGrowthFact,
    renderFortifyShieldFact,
    renderMindControlSwapFact,
    renderMindControlFailFact,
    renderMindControlBannerFact,
    renderQianKunUpgradedFact,
    renderQianKunBasicFact,
    renderKuaiLeHealFact,
    renderSpiderTransformFact,
    renderSpiderReturnFact,
    renderSpiderStrikeFact,
    ...
    renderStunSkipFact,
    renderFlySkipFact,
    renderHorseReboundFact,
    renderFortifyReboundFact,
    renderMeteorSplashGrowthFact,
    renderWarriorExecuteFact,
    ...
    renderZhangTauntFact,
    renderXingFenExtraAttackFact,
    renderXinHunDeathFact,
    renderClawNoHealFact,
    renderClawHitFact,
    renderClawExecuteFact,
    renderClawHealFact,
    renderPhantomRevealFact,
    renderPhantomConfuseFact,

...
// 复发信号：张三丰存活到第6回合，但战报全程没有「🛡️ 严阵以待：张三丰 防御+50% 反弹50%」摘要
//          → 多半是 tenRoundFortify.round 被回退成 10（本应在第6回合开始就挂，回退后要到第11回合才开始）
// 对应已报 Bug：V6.1.6 曾「撤回严阵以待」、V6.1.7 改 round 10→5；阈值回退会让张三丰前10回合毫无减伤/反弹
// 口径：
...
export const VER = 'tests/health-rules/141-zhangsanfeng-fortify-round.js V6.0.0';
